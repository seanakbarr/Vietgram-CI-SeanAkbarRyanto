    ...
    <main id="feed">
        ...
        <div class="photo">
            ...
            <div class="photo__info">
                ...
                <span class="photo__likes"><?= $f['likes'] ?> likes</span>
                <ul class="photo__comments">
                    <li class="photo__comment">
                        <span class="photo__comment-author"><?=$f['caption']?></span>
                    </li>
                    <!-- <li class="photo__comment">
