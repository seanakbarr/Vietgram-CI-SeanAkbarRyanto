        ...
        <div class="edit-profile__container">
            <header class="edit-profile__header">
                <div class="edit-profile__avatar-container">
                    <img src="assets/images/<?=$profile['dp']?>" class="edit-profile__avatar" />
                </div>
                <h4 class="edit-profile__username"><?= $profile['username']?></h4>
            </header>
            <form action="<?= base_url().'C_editprofile/edit'?>" class="edit-profile__form" method="post">
                <div class="form__row">
                ...
                <div class="form__row">
                    ...
                    <input id="phone" type="tel" class="form__input"  name="phonenumber" value="<?= $profile['phonenumber']?>"/>
                </div>
                <div class="form__row">
